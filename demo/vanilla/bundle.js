var WebviewSdk = (function (exports) {
    ...
    const MINI_APP_VISIBILITY_VALUES = [
     ...
     */
    const MINI_APP_VISIBILITY_DEPRECATES = [
        { symbol: "currentState()", kind: 'function', platforms: ['android', 'ios'], replacement: 'currentVisibility()', note: "" },
        { symbol: "observeLifecycle(...)", kind: 'function', platforms: ['android', 'ios'], replacement: null, note: "KHÔNG trỏ trống sang observeVisibility. Hai tín hiệu 'đang khởi tạo' và 'lỗi kèm thông điệp' không có chỗ trên trục năm giá trị, nên cần chúng thì tiếp tục gọi hàm này — nó chạy y nguyên, không có kế hoạch gỡ." },
        { symbol: "MiniAppDisplayState", kind: 'type', platforms: ['android'], replacement: 'MiniAppVisibility', note: "" },
        { symbol: "MiniAppDisplayState", kind: 'type', platforms: ['ios'], replacement: 'MiniAppVisibility', note: "" },
        { symbol: "MiniAppLifecycle", kind: 'type', platforms: ['android'], replacement: null, note: "Initialization và Error(msg) không có đường thay." },
        { symbol: "VDOMiniAppLifecycleType", kind: 'type', platforms: ['ios'], replacement: null, note: "initialization và inError không có đường thay." },
    ];
    /**
     * Cac ten TRONG GIA DINH la se bi phe thai nhung KHONG — ghi ra de khong ai
     * 'don dep' chung o luot sau. Moi dong kem ly do.
     */
    const MINI_APP_VISIBILITY_NOT_DEPRECATED = [
        { symbol: "HostAppEventType", platforms: ['android'], reason: "Đi SDK → TRANG MINI-APP, không đi tới app chủ. MiniAppVisibility không thay thế nó; đánh dấu phế thải ở đây là trỏ người đọc sang một API làm việc khác." },
        { symbol: "VDOHostAppEventType", platforms: ['ios'], reason: "Như trên. Chỉ có 3 case và không tên nào trùng bản Android — đó là một lệch riêng, không thuộc trục này." },
    ];
     ...
     */
    function errorCodesEmittedOnlyBy(platform) {
    ...
    exports.MINI_APP_VISIBILITY_DEPRECATES = MINI_APP_VISIBILITY_DEPRECATES;
    exports.MINI_APP_VISIBILITY_NOT_DEPRECATED = MINI_APP_VISIBILITY_NOT_DEPRECATED;
    exports.MINI_APP_VISIBILITY_VALUES = MINI_APP_VISIBILITY_VALUES;
    ...
    exports.SDK_ERROR_CATALOG = SDK_ERROR_CATALOG;
    ...
    exports.errorCodesEmittedOnlyBy = errorCodesEmittedOnlyBy;
    exports.executeLocalAuthentication = executeLocalAuthentication;
    exports.exit = exit;
    exports.expiredSession = expiredSession;

...
const CSS_SHARED = `/* AUTO-GENERATED by demo/demo.js from events.json — DO NOT EDIT (chay: npm run demo) */
...
`
  ...
  const html = `<!-- AUTO-GENERATED by demo/demo.js from events.json — DO NOT EDIT (chay: npm run demo) -->
<div class="container">
...
function genReactApp(events) {
  ...
  return `// AUTO-GENERATED by demo/demo.js from events.json — DO NOT EDIT (chay: npm run demo)
